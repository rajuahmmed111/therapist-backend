...
const createOrUpdateAboutUs = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (existingAboutUs) {
        ...
        const updatedAboutUs = await AboutUs.updateOne({ _id: existingAboutUs._id }, { description }, { runValidators: true });
